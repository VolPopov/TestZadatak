export class Dashboard {
  constructor(page) {
    ...
    this.cartUpperMenu = page.locator(
      "section[class='h-fit w-full text-center relative']"
    );
    this.clearButton = this.cartUpperMenu.locator('button');
    this.emptyCart = this.cartMenu.locator(
      "div:has-text('No items in cart. Add some!')"
    );
  }
